...
![|wide](https://dxyt-july-image.oss-cn-beijing.aliyuncs.com/CSDN/List_cover.png)
...
![|inline](https://dxyt-july-image.oss-cn-beijing.aliyuncs.com/CSDN/SList_show_4_19.png)
...
![|inline](https://dxyt-july-image.oss-cn-beijing.aliyuncs.com/CSDN/SListPushBack_Debug1.png)
但是当我继续 `F10` 希望进入循环时：
...
![|inline](https://dxyt-july-image.oss-cn-beijing.aliyuncs.com/CSDN/SListPushBack_Debug3.png)

多尾插几个数据试验一下：

![|inline](https://dxyt-july-image.oss-cn-beijing.aliyuncs.com/CSDN/SListPushBack_Debug4.png)
